...
| 能力 | NotebookLM | Notion/Obsidian | XMind | Quizlet/Anki | DeepL | **DeepStudent** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| 围绕资料 AI 问答 | ✓ 仅Gemini | △ Notion AI | ✗ | △ Q-Chat | ✗ | **✓ 9家模型** |
| 数据本地存储 | ✗ 云端 | △ | ✓ | △ | ✗ | **✓** |
| 云同步 | ✓ 原生 | ✓ | ✓ | ✓ | ✓ | **△ 实验性** |
| 开源 / 可自托管 | ✗ | ✗ | ✗ | △ Anki开源 | ✗ | **✓ AGPL-3.0** |
| 导入自动索引 | ✓ | △ | ✗ | ✗ | ✗ | **✓ 含OCR** |
| 统一数据层 (VFS) | ✗ | ✗ | ✗ | ✗ | ✗ | **✓** |
| 笔记系统 | △ 简单笔记 | ✓ 核心功能 | △ 节点备注 | △ Magic Notes | ✗ | **✓ 富文本+标签+AI** |
| AI 生成知识导图 | ✓ | ✗ | ✓ AI Copilot | ✗ | ✗ | **✓** |
| 导图 ↔ 大纲双模式 | ✗ | △ | ✓ Outliner | ✗ | ✗ | **✓** |
| AI 出题 + 练习 | ✓ | ✗ | ✗ | ✓ Learn模式 | ✗ | **✓** |
| 深度调研 + 论文搜索 | ✗ | ✗ | ✗ | ✗ | ✗ | **✓ 多引擎+arXiv** |
| 闪卡 + 间隔重复 | △ 无SRS | ✗ | ✗ | ✓ 成熟SRS | ✗ | **✓ 对接Anki生态** |
| 翻译质量 | ✗ | ✗ | ✗ | ✗ | ✓ 专业引擎 | **△ LLM驱动** |
| AI 作文批改 | ✗ | △ Notion AI | ✗ | ✗ | △ DeepL Write | **✓ 多场景评分** |
| 跨模块数据流转 | △ | △ | ✗ | ✗ | ✗ | **✓** |
| 多人协作 | △ 可共享 | ✓ | △ 协作版 | ✓ | ✗ | **✗** |
| 社区与生态 | ✓ | ✓ 插件丰富 | ✓ | ✓ | ✓ | **△ 新项目** |
