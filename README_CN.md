...
| 能力 | NotebookLM | Open Notebook | DeepTutor | Notion/Obsidian | **DeepStudent** |
|---|:---:|:---:|:---:|:---:|:---:|
| 围绕资料 AI 问答 | ✓ 仅Gemini | ✓ 多模型 | ✓ 多Agent | △ Notion AI | **✓ 9家模型** |
| 数据本地存储 | ✗ 云端 | ✓ Docker | ✓ Docker | △ | **✓** |
| 云同步 | ✓ 原生 | ✗ | ✗ | ✓ | **△ 实验性** |
| 开源 / 可自托管 | ✗ | ✓ | ✓ AGPL-3.0 | ✗ | **✓ AGPL-3.0** |
| 跨平台开箱即用 | ✓ 全平台 | △ 需Docker | △ 需Docker | ✓ 全平台 | **✓ Win/Mac/Linux/Android** |
| 导入自动索引 | ✓ | ✓ | ✓ | △ | **✓ 含OCR** |
| 统一数据层 (VFS) | ✗ | ✗ | ✗ | ✗ | **✓** |
| 智能记忆系统 | ✗ | ✗ | △ 会话记忆 | ✗ | **✓ AI驱动持久化** |
| 笔记系统 | △ 简单笔记 | △ AI笔记 | △ Notebook | ✓ 核心功能 | **✓ 富文本+标签+AI** |
| AI 生成知识导图 | ✓ | ✗ | △ 可视化 | ✗ | **✓** |
| 导图 ↔ 大纲双模式 | ✗ | ✗ | ✗ | △ | **✓** |
| AI 出题 + 练习 | ✓ | ✗ | ✓ 模拟出题 | ✗ | **✓** |
| 深度调研 + 论文搜索 | △ Discover | ✗ | ✓ | ✗ | **✓ 多引擎+arXiv** |
| 闪卡 + 间隔重复 | △ 无SRS | ✗ | ✗ | ✗ | **✓ 对接Anki生态** |
| 翻译与精读 | ✗ | ✗ | ✓ PDF翻译 | ✗ | **✓ 7种领域预设** |
| AI 作文批改 | ✗ | ✗ | ✗ | △ Notion AI | **✓ 多场景评分** |
| 跨模块数据流转 | △ | △ | △ | △ | **✓** |
| MCP 生态 / 技能扩展 | ✗ | ✗ | ✓ MCP Registry | ✗ | **✓ 原生+预置服务** |
| 多人协作 | △ 可共享 | ✗ | ✗ | ✓ | **✗** |
| 社区与生态 | ✓ | △ 新项目 | △ 新项目 | ✓ 插件丰富 | **△ 新项目** |
